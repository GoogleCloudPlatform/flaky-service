...
async function main () {
  try {
    ...
    metaData.environment.matrix = JSON.parse(JSON.stringify(metaData.environment.matrix, Object.keys(metaData.environment.matrix).sort())); // consistancy
...
let convert;
try {
	convert = __webpack_require__(957).convert;
} catch (e) {}
...
Object.defineProperty(exports, "__esModule", { value: true });
const command_1 = __webpack_require__(79);
const os = __importStar(__webpack_require__(87));
